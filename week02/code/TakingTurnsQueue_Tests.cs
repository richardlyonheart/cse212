...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Sue was at the beginning instead of Bob personqueue file was adding person to the front rather than in order
    ...
    // Defect(s) Found: was showing failed but fixed with same fix of first part
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: was showing failed but fixed with same fix as first part
    ...
    // Defect(s) Found: was showing failed but fixed with same fix as first code
